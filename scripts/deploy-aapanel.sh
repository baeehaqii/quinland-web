...
/www/server/panel/pyenv/bin/supervisorctl restart "quinland-worker:*" 2>/dev/null || \
  /www/server/panel/pyenv/bin/supervisorctl start "quinland-worker:*" 2>/dev/null || true
